...
class DummySampler(Sampler):
    def __init__(self):
        ...
        super().__init__(is_stochastic=False, alpha=alpha, sigma=sigma, schedule_params=schedule_params)
...
def model(dummy_net, dummy_sampler):
    ...
    return DiffusionModel(
        ...
        scheduler=optim.lr_scheduler.StepLR(optim.Adam(dummy_net.parameters(), lr=1e-4), step_size=1),
        val_metrics={},
...
def test_model_forward():
    ...
    model = DiffusionModel(
        ...
        scheduler=optim.lr_scheduler.StepLR(optim.Adam(net.parameters(), lr=1e-4), step_size=1),
        val_metrics={},
